...
export function NotesSection() {
  return (
    <section className="flex flex-col gap-4 border border-paragraph/10 rounded-lg overflow-hidden px-4 py-7">
      ...
      <div className="mt-1 flex items-center justify-center p-2 rounded-lg border border-paragraph/7 md:bg-foreground font-semibold text-paragraph hover:text-paragraph/70 hover:border-paragraph/7 transition-colors duration-300">
        <span className="text-sm text-paragraph/70">Soon</span>
      </div>
    </section>
  );
}
